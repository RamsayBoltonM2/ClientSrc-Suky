...
enum
{
	...
	HEADER_CG_ITEM_PICKUP						= 14,
	HEADER_CG_QUICKSLOT_ADD                     = 15,
	HEADER_CG_QUICKSLOT_DEL                     = 16,
	HEADER_CG_QUICKSLOT_SWAP                    = 17,
	HEADER_CG_WHISPER							= 18,
	HEADER_CG_ITEM_DROP2                        = 19,	
	HEADER_CG_ON_CLICK							= 20,
	HEADER_CG_EXCHANGE							= 21,
    HEADER_CG_CHARACTER_POSITION                = 22,
    HEADER_CG_SCRIPT_ANSWER						= 23,
	HEADER_CG_QUEST_INPUT_STRING				= 24,
    HEADER_CG_QUEST_CONFIRM                     = 25,
	HEADER_CG_PVP								= 26,	/*** Only Client ***/
    HEADER_CG_SHOP								= 27,
	HEADER_CG_FLY_TARGETING						= 28,
	HEADER_CG_USE_SKILL							= 29,
    HEADER_CG_ADD_FLY_TARGETING                 = 30,
	HEADER_CG_SHOOT								= 31,
	HEADER_CG_MYSHOP                            = 32,    
	HEADER_CG_ITEM_USE_TO_ITEM					= 33,
    HEADER_CG_TARGET                            = 34,
	HEADER_CG_TEXT								= 35,	/*** Only Server ***/
	HEADER_CG_WARP								= 36, 
    HEADER_CG_SCRIPT_BUTTON						= 37,
    HEADER_CG_MESSENGER                         = 38,
    HEADER_CG_MALL_CHECKOUT                     = 39,
    HEADER_CG_SAFEBOX_CHECKIN                   = 40,
    HEADER_CG_SAFEBOX_CHECKOUT                  = 41,
    HEADER_CG_PARTY_INVITE                      = 42,
    HEADER_CG_PARTY_INVITE_ANSWER               = 43,
    HEADER_CG_PARTY_REMOVE                      = 44,
    HEADER_CG_PARTY_SET_STATE                   = 45,
    HEADER_CG_PARTY_USE_SKILL                   = 46,
    HEADER_CG_SAFEBOX_ITEM_MOVE                 = 47,
	HEADER_CG_PARTY_PARAMETER                   = 48,
	HEADER_CG_GUILD								= 49,
	HEADER_CG_ANSWER_MAKE_GUILD					= 50,
    HEADER_CG_FISHING                           = 51,
    HEADER_CG_GIVE_ITEM                         = 52,
    HEADER_CG_EMPIRE                            = 53,
    HEADER_CG_REFINE                            = 54,
	HEADER_CG_MARK_LOGIN						= 55,
	HEADER_CG_MARK_CRCLIST						= 56,
	HEADER_CG_MARK_UPLOAD						= 57,
	HEADER_CG_MARK_IDXLIST						= 58,
	HEADER_CG_CRC_REPORT						= 59,	/*** Only Server ***/	
	HEADER_CG_HACK								= 60,
    HEADER_CG_CHANGE_NAME                       = 61,
    HEADER_CG_SMS                               = 62,	/*** Only Client ***/
    HEADER_CG_LOGIN2                            = 63,
	HEADER_CG_DUNGEON							= 64,
	HEADER_CG_LOGIN3							= 65,
	HEADER_CG_GUILD_SYMBOL_UPLOAD				= 66,
	HEADER_CG_GUILD_SYMBOL_CRC					= 67,
	HEADER_CG_SCRIPT_SELECT_ITEM				= 68,
	HEADER_CG_LOGIN4							= 69,	/*** Only Client ***/
	HEADER_CG_STATE_CHECKER						= 70,
	HEADER_CG_QUEST_RECEIVE						= 71,
	...
	HEADER_GC_CHARACTER_UPDATE_NEW				= 24,	/*** Only Server ***/
	...
	HEADER_GC_LOGIN_SUCCESS4					= 32,	/*** Only Client ***/
	HEADER_GC_ITEM_UNBIND_TIME					= 33,	/*** Only Client ***/
	HEADER_GC_WHISPER							= 34,
	HEADER_GC_ALERT								= 35,	/*** Only Client ***/
	HEADER_GC_MOTION							= 36,
	HEADER_GC_PARTS								= 37,	/*** Only Server ***/
	HEADER_GC_SHOP							    = 38,
	...
	HEADER_GC_MOUNT								= 47,
	HEADER_GC_OWNERSHIP                         = 48, 
    HEADER_GC_TARGET                            = 49,
	HEADER_GC_WARP								= 50, 
	HEADER_GC_ADD_FLY_TARGETING                 = 51,
	HEADER_GC_CREATE_FLY						= 52,
	HEADER_GC_FLY_TARGETING						= 53,
	HEADER_GC_SKILL_LEVEL						= 54,
	HEADER_GC_SKILL_COOLTIME_END				= 55,	/*** Only Client ***/
    HEADER_GC_MESSENGER                         = 56,
	HEADER_GC_GUILD								= 57,
	HEADER_GC_SKILL_LEVEL_NEW					= 58,
    HEADER_GC_PARTY_INVITE                      = 59,
    HEADER_GC_PARTY_ADD                         = 60,
    HEADER_GC_PARTY_UPDATE                      = 61,
    HEADER_GC_PARTY_REMOVE                      = 62,
    HEADER_GC_QUEST_INFO                        = 63,
    HEADER_GC_REQUEST_MAKE_GUILD                = 64,
	HEADER_GC_PARTY_PARAMETER                   = 65,
    HEADER_GC_SAFEBOX_MONEY_CHANGE              = 66,
    HEADER_GC_SAFEBOX_SET                       = 67,
    HEADER_GC_SAFEBOX_DEL                       = 68,
    HEADER_GC_SAFEBOX_WRONG_PASSWORD            = 69,
    HEADER_GC_SAFEBOX_SIZE                      = 70,
    HEADER_GC_FISHING                           = 71,
    HEADER_GC_EMPIRE                            = 72,
    HEADER_GC_PARTY_LINK                        = 73,
    HEADER_GC_PARTY_UNLINK                      = 74,
    HEADER_GC_REFINE_INFORMATION                = 75,
	HEADER_GC_OBSERVER_ADD						= 76,	/*** Only Client ***/
	HEADER_GC_OBSERVER_REMOVE					= 77,	/*** Only Client ***/
	HEADER_GC_OBSERVER_MOVE						= 78,	/*** Only Client ***/
	HEADER_GC_VIEW_EQUIP                        = 79,
	HEADER_GC_MARK_BLOCK						= 80,
	HEADER_GC_MARK_DIFF_DATA                    = 81,	/*** Only Client ***/
	HEADER_GC_MARK_IDXLIST						= 82,
    HEADER_GC_TIME                              = 83,
    HEADER_GC_CHANGE_NAME                       = 84,
	HEADER_GC_DUNGEON							= 85,
	HEADER_GC_WALK_MODE							= 86, 
	HEADER_GC_CHANGE_SKILL_GROUP				= 87,
	HEADER_GC_MAIN_CHARACTER2_EMPIRE			= 88,
    HEADER_GC_SEPCIAL_EFFECT                    = 89,
	HEADER_GC_NPC_POSITION						= 90,
    HEADER_GC_CHARACTER_UPDATE2                 = 91,	/*** Only Client ***/
    HEADER_GC_LOGIN_KEY                         = 92,
    HEADER_GC_REFINE_INFORMATION_NEW            = 93,
    HEADER_GC_CHARACTER_ADD2                    = 94,	/*** Only Client ***/
    HEADER_GC_CHANNEL                           = 95,
    HEADER_GC_MALL_OPEN                         = 96,
	HEADER_GC_TARGET_UPDATE                     = 97,
	HEADER_GC_TARGET_DELETE                     = 98,
	HEADER_GC_TARGET_CREATE_NEW                 = 99,
	HEADER_GC_AFFECT_ADD                        = 100,
	HEADER_GC_AFFECT_REMOVE                     = 101,
    HEADER_GC_MALL_SET                          = 102,
    HEADER_GC_MALL_DEL                          = 103,
	HEADER_GC_LAND_LIST                         = 104,
	HEADER_GC_LOVER_INFO						= 105,
	HEADER_GC_LOVE_POINT_UPDATE					= 106,
	HEADER_GC_GUILD_SYMBOL_DATA					= 107,
    HEADER_GC_DIG_MOTION                        = 108,
	HEADER_GC_DAMAGE_INFO						= 109,
	HEADER_GC_CHAR_ADDITIONAL_INFO				= 110,
	HEADER_GC_MAIN_CHARACTER3_BGM				= 111,
	HEADER_GC_MAIN_CHARACTER4_BGM_VOL			= 112,
    HEADER_GC_AUTH_SUCCESS                      = 113,
    HEADER_GC_PANAMA_PACK						= 114,
	HEADER_GC_HYBRIDCRYPT_KEYS					= 115,
	HEADER_GC_HYBRIDCRYPT_SDB					= 116,
	HEADER_GC_SPECIFIC_EFFECT					= 117,
	HEADER_GC_RESPOND_CHANNELSTATUS				= 118,
...
typedef struct command_elder_attribute
{
	BYTE byHeader;
	int attributetype1;
	int attributetype2;

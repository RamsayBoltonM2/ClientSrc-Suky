...
void CPythonGuild::SetGuildEXP(BYTE byLevel, long long dwEXP)
{
...
long long CPythonGuild::GetGuildExperienceSummary()
{
...
PyObject * guildGetGuildExperience(PyObject * poSelf, PyObject * poArgs)
{
	...
	return Py_BuildValue("il", rGuildInfo.dwCurrentExperience, lastExp - rGuildInfo.dwCurrentExperience);
}
...
{
	return Py_BuildValue("L", CPythonGuild::Instance().GetGuildExperienceSummary());
}
